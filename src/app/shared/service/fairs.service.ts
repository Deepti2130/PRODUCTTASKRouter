...
export class FairsService {
  ...
  fetchAllfairs():Array<Ifair>{
    //API call to call fairs
    return this.fairsArr
  }

  fetchFair(id:string):Observable<Ifair>{
//API call single fair

 return of (this.fairsArr.find(fair=>fair.fairId === id)!)
  }

  //when we subscribe then we will get single fair object
}
